...
var slicedarr = groceryList.slice(0, 2)
console.log(slicedarr.push("beans"))
...
var arr1 = ["Alex", "Dane", "Nate"]
var arr2 = ["Stevie", "Kendra", "Paula"]
...
console.log(sorted1.reverse())
console.log(sorted2.reverse())

// Write the code that sorts all the names in alphabetical order in a single array.

var sortedNames = arr1.concat(arr2).sort()
